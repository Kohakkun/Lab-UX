...
public class YourLieInAprilDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.your_lie_in_april_fragment_detail, container, false);
    ...
    private void setAnimeDetails() {
        animeTitle.setText("Your Lie in April");
        animeImage.setImageResource(R.drawable.animecover7);
        animeType.setText("Type: TV");
        animeEpisodes.setText("Episodes: 22");
    ...
    private void addInitialReviews() {
        reviewsList.add(new Review("PianistInTears", "This anime is a beautiful tragedy. The music is phenomenal and the story will break your heart in the best way possible.", R.drawable.review_profile));
        reviewsList.add(new Review("KaoriMySunshine", "The vibrant colors and animation are stunning, perfectly contrasting the emotional story. Kaori brought color to Kousei's world and mine.", R.drawable.review_profile));
        reviewsList.add(new Review("ClassicalFan", "As a classical music lover, this was a treat. The performances are so emotional and powerful. Prepare to cry. A lot.", R.drawable.review_profile));
    }
